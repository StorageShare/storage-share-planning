...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <x-form-input
            ...
            :value="$prefillData['feedback_owner_name'] ?? $currentTask->feedback_owner_name ?? ''"
        ...
        <x-form-input
            ...
            :value="$prefillData['feedback_emails'] ?? $currentTask->feedback_emails ?? ''"
    ...
    <div>
        ...
        <label for="new-photos" class="block cursor-pointer border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6" onpaste="handlePaste(event)">
